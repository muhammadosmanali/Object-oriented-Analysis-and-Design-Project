...
namespace investandbusinessplace
{
    public partial class invester_reset : UserControl
    {
        ...
        private void btnReset_Click(object sender, EventArgs e)
        {
            ...
            {
                connection.Open();
                Select = "Select * From Invester where Email = '" + txtEmail.Text + "' and Question = '" + cmbSelectQuestion.Text + "' and Answer = '" + txtAnswer.Text + "'";
                ...
                if (tbl.Rows.Count >= 1)
                {
                    ...
                    {
                        newselect = "Update Invester set Password = '" + txtPassword.Text + "' where Email = '" + txtEmail.Text + "' and Question = '" + cmbSelectQuestion.Text + "' and Answer = '" + txtAnswer.Text + "'";
